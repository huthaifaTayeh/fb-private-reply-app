    ...
    if (body.object === 'page') {
        ...
        body.entry.forEach(function(entry) {
            ...
            if(entry.messaging){
                ...
                let webhook_changes = entry.changes[0]
                console.log("CHANGES ARE =====================\n")
                console.dir(webhook_changes)
                if(webhook_changes.value.post){
                    callSendReplyAPI(webhook_changes.value.comment_id, webhook_changes.value.message)
                }
            }
        });
...
function callSendReplyAPI(sender_psid, response) {
    // Construct the message body
    let request_body = {
        "recipient": {
...
function handleMessage(sender_psid, message) {
    ...
    entitiesArr.forEach((name) => {
        ...
        if (entity && entity.confidence > 0.8) {
            entityChosen = name;
            console.log('entityChosen: ', entityChosen, "  ======  ", message.nlp)
        }
    });
